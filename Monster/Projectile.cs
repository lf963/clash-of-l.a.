...
public class Projectile : MonoBehaviour {
	...
	public void Initialize(RangeAttack parent)
	{
...
//			}
	...
	private void OnTriggerEnter2D(Collider2D other)
	{
		...
		if (other.tag == "RedPortal") {
			//GameManager.Instance.DamagingUCLA.Add (this.GetComponentInParent<Monster>());
			GameManager.Instance.Player.Health_UCLA.CurrentVal -= parent.Damage;
		}
